...
namespace GeonBit.UI.Entities
{
    ...
    public enum ImageDrawMode
    {
        ...
        /// <summary>With this mode the texture will be displayed at unscaled size in uper left of its dest rect</summary>
        ExactTopLeft = 3,
    }
        ...
        override protected void DrawEntity(SpriteBatch spriteBatch, DrawPhase phase) {
            ...
            if (Texture != null)
            {
                ...
                switch (DrawMode)
                {
                    ...
                    case ImageDrawMode.ExactTopLeft:
                        {
                            var rectSource = new Rectangle(0, 0, Texture.Width, Texture.Height);
